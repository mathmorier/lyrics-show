<nav id="nav-princ">
    ...
    <div id="slider-princ" class="slider">
        <ul>
            ...
            <li><a href="/tvsong"><i class="fa-solid fa-pen-to-square"></i> Base Song Edit</a></li>
        </ul>
        <div id="list">
            <div id="list-link">
            ...
            <div id="list-btn">
                ...
                <button id="setting-lyrics" onclick="window.location.replace('/edit/list')"><i class="fa-solid fa-pen"></i></button>
